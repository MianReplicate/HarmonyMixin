...
public class RedirectMethod : BaseModification<RedirectMethod>
{
    protected static List<RedirectMethod> Modifications = new();
    
    public RedirectMethod(string methodInvokedIn, Type typeTargetMethodIn, string targetMethodName, int ordinal = 0, int priority = 500) : base(methodInvokedIn, InjectionType.Invoke, Shift.Before, typeTargetMethodIn, targetMethodName, ordinal, priority)
    {
